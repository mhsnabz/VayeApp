...
public class GizlilikActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            AssetManager assetManager = GizlilikActivity.this.getAssets();
            InputStream stream = assetManager.open("gizlilik.html");
    ...
    private void setToolbar() {
        ...
        toolbarTitle.setText("Gizlilik Politikası");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                Helper.shared().back(GizlilikActivity.this);
            }
        });
    }
