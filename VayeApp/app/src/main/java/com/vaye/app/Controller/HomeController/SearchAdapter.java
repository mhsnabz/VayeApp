...
public class SearchAdapter  extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SearchAdapter(ArrayList<OtherUser> list, Context context, CurrentUser currentUser) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        SearchListViewHolder userListViewHolder = (SearchListViewHolder) holder;
        OtherUser model = list.get(position);
        ...
        userListViewHolder.setUserNumber(model.getShort_school() + "-" + model.getBolum());
    ...
    public int getItemCount() {
        Log.d("HomeActivity", "getItemCount: " + list.size());
        return list.size();
    }
